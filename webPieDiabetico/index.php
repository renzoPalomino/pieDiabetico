...
<!--video-->
<div id="video" class="fullscreen"></div>

<!--mensaje-->
<div id="mensaje" class="mensaje navbar fullscreen">
...
<!--mensaje1-->
<div id="mensaje1" class="navbar bg-verdeoscuro ">
<div class="mensaje1 container mt-5 pt-5">
  <div class="row">
    ...
    <div class="col-md-5 text-center">
      <img class="img-fluid" src="/img/amputacion.svg" style="height: 230px;"/>
    </div>
  </div>
  </div>

  <!--mensaje2-->
<div id="mensaje2" class="mensaje2 container my-5">
  <div class="row">
    <div class="col-md-5 text-center">
      <img class="img-fluid" src="/img/time.svg" style="height: 230px;"/>
    </div>
    <div class="tarjeta border col-md-7">
    <div class="p-5"> 
...
<!--info-->
<div id="info" class="navbar bg-gray">
  ...
  <div class="col-md-8">
    <div class="row">
      ...
      <div class="col-md-12 py-4">
        <div>VIDA DIABÉTICA es un Centro Especializado en tratamiento de pie diabético y heridas complejas. Nuestro objetivo es luchar por tu pie para devolver su función, es decir caminar.</div>
