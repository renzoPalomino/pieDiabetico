  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Ozonoterapia en bolsa</h4>
...
<div class="modal" id="myModa2">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal1 Header -->
      <div class="modal-header">
        <h4 class="modal-title">Aceite ozonizado</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
...
<div class="modal" id="myModa3">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal1 Header -->
      <div class="modal-header">
        <h4 class="modal-title">Sistema cierre asistido al vacio (VAC)</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
...
<div class="modal" id="myModa4">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal1 Header -->
      <div class="modal-header">
        <h4 class="modal-title">Podología especializada</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
...
<div class="modal" id="myModa6">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal1 Header -->
      <div class="modal-header">
        <h4 class="modal-title">Plasma rico en plaquetas</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
...
<div class="modal" id="myModa7">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal1 Header -->
      <div class="modal-header">
        <h4 class="modal-title">Crema hidratante para pie diabético</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
